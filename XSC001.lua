...
-- Input fields
createLabel("Delay sebelum beli item 1 (detik)", 10)
local delayItem1Box = createBox(60, 30)

createLabel("Delay sebelum ganti map (detik)", 60)
local delayChangeMapBox = createBox(30, 80)

createLabel("Delay sebelum beli item 2 (detik)", 110)
local delayItem2Box = createBox(60, 130)

createLabel("Durasi Comprehend (detik)", 160)
local comprehendBox = createBox(120, 180)

createLabel("Durasi UpdateQi sesudahnya (detik)", 210)
local updateQiAfterBox = createBox(120, 230)
